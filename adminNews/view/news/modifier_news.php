...
<div class="container" style="margin-top:20px;">
    <form action="index.php?ctrl=news&action=modifier_action" method="post">
        <input type="hidden" name="id" value="<?php echo $new->id; ?>"/>
        <div class="form-group">
            <label for="titre">Titre de la news :</label>
            <input class="form-control" type="text" value="<?php echo $new->titre; ?>" name="titre" id="titre">
        </div>
        <br>
        <div class="form-check">
            <label class="form-check-label">
                <input name="accueil" id="accueil" type="checkbox" <?php if($new->accueil == 1){echo " checked ";}; ?> class="form-check-input">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="date" value="<?php echo $new->date_news; ?>" name="date_news" id="date_news">
        </div>
        <div class="form-group">
            <label for="contenu">Contenu de la news :</label>
            <textarea name="contenu" class="form-control" id="contenu" rows="3" style="height:500px;"><?php echo $new->contenu; ?></textarea>
        </div>
        <button type="submit" class="btn btn-primary">Modifier cette news</button><br><br>
    </form>
</div>
<style>
    i{
